...
def plotar_grafico(tamanhos, tempos):
    ...
    plt.title("Tempo de execução da BFS por tamanho do grafo")
    plt.xlabel("Número de vértices")
    plt.ylabel("Tempo (s)")
    plt.grid(True)
    plt.savefig("tp4_ex33.png")
...
if __name__ == "__main__":
    ...
    tamanhos, tempos = testar_tempos_bfs()
